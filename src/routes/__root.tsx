  ...
  head: () => ({
    meta: [
      ...
      { title: " Mapa Interactivo" },
      {
        name: "description",
        content:
          "Mapa interactivo de Hitt0 zzESzz. Consulta ubicaciones, NPCs, recursos y enemigos.",
      },
      { name: "author", content: "Hitt0" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "Mapa Interactivo" },
      { name: "twitter:title", content: "Mapa Interactivo" },
      { property: "og:description", content: "Mapa interactivo. Consulta ubicaciones, NPCs, recursos y enemigos." },
      { name: "twitter:description", content: "Mapa interactivo. Consulta ubicaciones, NPCs, recursos y enemigos." },
